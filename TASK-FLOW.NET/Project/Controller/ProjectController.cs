...
namespace TASK_FLOW.NET.Project.Controller
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> CreateProject([FromBody] CreateProjectDTO body)
        {
        ...
        public async Task<ActionResult<PublicProjectDTO>> GetProjectById(int id)
        {
            return Ok(await this._service.FindProjectById(id));
        }
